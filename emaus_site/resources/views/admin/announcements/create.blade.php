...
@section('title', 'Novo Recado')

@section('content')
<div class="card" style="max-width: 640px;">
    <div class="card-header">
        <h3 style="font-size: 1rem; font-weight: 600;">Novo Recado</h3>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                <div class="form-group">
                    ...
                    <select name="type" class="form-control" required>
                        <option value="group" {{ old('type') == 'group' ? 'selected' : '' }}>Recado do Grupo</option>
                        <option value="parish" {{ old('type') == 'parish' ? 'selected' : '' }}>Recado da Paróquia</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>Ordem</label>
